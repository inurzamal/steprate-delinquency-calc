...
//    }
    ...
    @Test
    void testCalculateAmortization() throws Exception {
        MockMvc mockMvc = MockMvcBuilders.standaloneSetup(amortizationController).build();
        mockMvc.perform(MockMvcRequestBuilders.post("/amortization/api/v1/calculate")
                .content(asJsonString(Instancio.create(AmortizationRequest.class)))
